...
/**
 * This class is used in the unit tests to contstruct ServerDescription instances. For production code
 * ServerDescription instances should be constructed using it's constructors.
 */
